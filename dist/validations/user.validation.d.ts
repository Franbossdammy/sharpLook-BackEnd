 ...
 */
export declare const updateLocationValidation: import("express-validator").ValidationChain[];
/**
 * Get nearby vendors validation
 */
export declare const getNearbyVendorsValidation: import("express-validator").ValidationChain[];
