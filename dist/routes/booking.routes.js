 ...
 * @access  Private (Admin)
 */
router.get('/admin/:bookingId', auth_1.authenticate, auth_1.requireAdmin, (0, validate_1.validate)(booking_validation_1.bookingIdValidation), booking_controller_1.default.getAdminBookingById);
/**
