...
class EmailService {
     ...
     */
    async sendVendorNewBookingEmail(email, vendorFirstName, booking) {
        ...
        return this.sendEmail(email, 'New Booking Request 📅', types_1.EmailTemplate.BOOKING_CONFIRMATION, {
